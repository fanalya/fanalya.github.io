...
const onSelect = (data: any) => {
  if (data.title == "Overview") {
    router.push("/ecommerce/order-overview");
  }
};
</script>

<template>
  <TCard title="Product Orders" class="col-span-12 2xl:col-span-12">
        ...
        >
          <template #title>
            <TButton
              color="slate"
              variant="soft"
              classes="flex px-2 py-1.5 text-xs"
            >
