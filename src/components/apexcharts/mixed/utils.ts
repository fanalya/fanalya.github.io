...
const mixedLineChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["bg-custom-500", "bg-orange-500"]'),
    dataLabels: {
      enabled: true,
      enabledOnSeries: [1],
    },
...
const lineAreaChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["bg-custom-200", "bg-green-500"]'),
    labels: [
      "Dec 01",
      "Dec 02",
      "Dec 03",
...
const lineColumnAreaChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray(
      '["bg-sky-500", "bg-orange-500","bg-purple-500"]'
    ),
    markers: {
      size: 0,
    },
...
const lineScatterChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["bg-custom-500", "bg-yellow-500"]'),
    tooltip: {
      shared: false,
      intersect: true,
    },
