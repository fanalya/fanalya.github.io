...
import {
  ...
  githubdata,
  dataSeries
} from "@/components/apexcharts/utils.ts";
...
const areaMonthsChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["bg-orange-500"]'),
    stroke: {
      width: 0,
      curve: "smooth"
    },
...
const areaStackedChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray(
      '["bg-custom-500", "bg-yellow-500", "bg-slate-200"]'
    ),
    dataLabels: {
      enabled: false
    },
...
const areaIrregularChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray(
      '["bg-custom-500", "bg-purple-500", "bg-green-500"]'
    ),
    fill: {
      type: "gradient",
      gradient: {
