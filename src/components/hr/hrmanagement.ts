...
export const DepartmentsListDataHeader = [
    { title: "#", value: "id" },
    { title: "Department Name", value: "departmentName" },
    { title: "Head of Dep.", value: "HOD" },
...
export const EmployeeListDataHeader = [
    ...
    { title: "Joining Date", value: "joinDate" },
    { title: "Action", value: "action" },
];
...
export const HolidaysDataHeader = [
    { title: "#", value: "id" },
    { title: "Day", value: "day" },
    { title: "Date", value: "date" },
    { title: "Holiday Name", value: "holidayName" },
...
export const AttendanceDataHeader = [
    { title: "Date", value: "date" },
    { title: "Check In", value: "checkIn" },
    { title: "Check Out", value: "checkOut" },
    { title: "Meal Break", value: "mealBreak" },
...
export const MainAttendanceDataHeader = [
    ...
    { title: "08", value: "Day8" },
    { title: "09", value: "Day9" },
    { title: "10", value: "Day10" },
    { title: "11", value: "Day11" },
    { title: "12", value: "Day12" },
    { title: "13", value: "Day13" },
    { title: "14", value: "Day14" },
    { title: "15", value: "Day15" },
    { title: "16", value: "Day16" },
    { title: "17", value: "Day17" },
    { title: "18", value: "Day18" },
    { title: "19", value: "Day19" },
    { title: "20", value: "Day20" },
    { title: "21", value: "Day21" },
    { title: "22", value: "Day22" },
    { title: "23", value: "Day23" },
    { title: "24", value: "Day24" },
    { title: "25", value: "Day25" },
    { title: "26", value: "Day26" },
    { title: "27", value: "Day27" },
    { title: "28", value: "Day28" },
    { title: "29", value: "Day29" },
    { title: "30", value: "Day30" },
];
...
export const leaveManagementHeader = [
    { title: "#", value: "id" },
    { title: "Leave Type", value: "leaveType" },
    { title: "Reason", value: "reason" },
    { title: "No Of Days", value: "noOfDays" },
    { title: "From", value: "from" },
    { title: "to", value: "to" },
    { title: "Approved", value: "approvedBy" },
...
export const LeaveAddHR = [
    { label: 'Medical Leave', value: '04' },
    { label: 'Casual Leave', value: '08' },
    { label: 'Sick Leave', value: '03' },
    { label: 'Annual Leave', value: '12' },
    { label: 'Use Leave', value: '09' },
    { label: 'Remaining Leave', value: '18' },
];

export const LeaveManageHRDataHeader = [
    { title: "#", value: "id" },
    { title: "Employee Name", value: "employeeName" },
    { title: "Leave Type", value: "leaveType" },
    { title: "Reason", value: "reason" },
...
export const EmployeeSalaryDataHeader = [
    { title: "Employee ID", value: "employeeId" },
    { title: "Joining Date", value: "joiningDate" },
    { title: "Name", value: "name" },
    { title: "Designation", value: "designation" },
...
export const EstimatesDataHeader = [
    { title: "Estimate Number", value: "estimateNumber" },
    { title: "Client Name", value: "clientName" },
    { title: "Estimate By", value: "estimateBy" },
    { title: "Estimate Date", value: "estimateDate" },
...
export const ExpensesDataHeader = [
    { title: "Purchase Date", value: "purchaseDate" },
    { title: "Item", value: "item" },
    { title: "Purchased By", value: "purchasedBy" },
...
export const PaymentsDataHeader = [
    { title: "Payment ID", value: "paymentId" },
    { title: "Membership Plan", value: "membershipPlan" },
    { title: "Date", value: "date" },
...
export const paySlipDataHeader = [
    { title: "Month", value: "month" },
    { title: "Salary Amount", value: "salaryAmount" },
    { title: "Deductions (TDS)", value: "deductions" },
    { title: "Professional Tax", value: "professionalTax" },
    { title: "Provident Fund", value: "providentFund" },
    { title: "Net Payable", value: "netPayable" },
    { title: "Status", value: "status" },
];
...
export { paySlipData , DepartmentsListData, EmployeeListData, HolidaysData, AttendanceData, MainAttendanceData, LeaveManageEmployeeData, LeaveManageHRData, EmployeeSalaryData, EstimatesData, ExpensesData, PaymentsData };